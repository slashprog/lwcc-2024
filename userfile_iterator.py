...
if __name__ == '__main__':
    ...
    with Users("users.csv") as users:  # users = Users("users.csv").__enter__()
        users["shivansh"] = dict(name="shivansh", password="secret", fullname="Shivansh Bansal")
        del users["larry"]
        print(users["shivansh"]["fullname"])
        ...
        print("shagun" in users)
        
        users["antony"]["password"] = "w3lc0me" # Tricky - but try solving this 
